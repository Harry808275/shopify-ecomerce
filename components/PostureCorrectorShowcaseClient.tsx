...
interface PostureCorrectorShowcaseClientProps {
  product: ProductData
}

export default function PostureCorrectorShowcaseClient({ product }: PostureCorrectorShowcaseClientProps) {
  ...
  const shortDescription = product.description
    ...
    : 'Premium quality product designed for your comfort and wellness.';
    ...
    <section className="py-8 lg:py-10 bg-gradient-to-br from-lv-light-gray/30 via-white to-lv-light-gray/20 overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-64 h-64 bg-lv-orange/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-lv-black/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2"></div>
          
          {/* Left Side - Image (Full Div) */}
          <motion.div
            initial={{ opacity: 0, x: -20 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5, ease: [0.4, 0, 0.2, 1] }}
            className="relative w-full h-full min-h-[250px] sm:min-h-[300px] md:min-h-[350px] lg:min-h-[400px] bg-gradient-to-br from-lv-light-gray/30 via-white to-lv-light-gray/20 overflow-hidden"
          >
            {product.image ? (
              <Image
                src={product.image}
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <svg className="w-20 h-20 text-lv-black/20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <motion.div
              ...
              className="absolute top-4 right-4 bg-lv-orange text-white px-3 py-1.5 rounded-md shadow-lg z-20"
            >
          ...
          <motion.div
            ...
            className="space-y-3 sm:space-y-4 relative z-10 p-6 sm:p-8 lg:p-10 flex flex-col justify-center"
          >
            {/* Badge */}
            ...
            <div className="flex items-center justify-between gap-4 pt-4 border-t border-lv-light-gray/30">
              ...
              <div className="flex gap-3 flex-1 justify-end">
                ...
                <Link
                  ...
                  className="lv-button-secondary text-sm py-3 px-6 text-center whitespace-nowrap"
                >
                  Details
                </Link>
              </div>
